...
class PatternMatcher:
    ...
    def __init__(self, patterns: Dict[str, Dict[str, str]], case_sensitive: bool = False):
        """
        ...
        for category, category_patterns in self.patterns.items():
            ...
            for pattern_name, pattern in category_patterns.items():
                ...
                try:
                    ...
                    raise ValueError(f"Invalid regex pattern '{pattern}' in {category}.{pattern_name}: {e}")
        
        return compiled
    
    def match_document(self, content: str, sections: Optional[Dict[str, str]] = None) -> Dict[str, List[PatternMatch]]:
        """
            ...
            for pattern_name, compiled_pattern in category_patterns.items():
                ...
                if sections:
                    for match in matches:
                        match.section = self._find_section_for_position(match.start, content, sections)
    ...
    def match_sections(self, sections: Dict[str, str]) -> Dict[str, List[PatternMatch]]:
        ...
        for category, category_patterns in self._compiled_patterns.items():
            ...
            for section_name in target_sections:
                ...
                for pattern_name, compiled_pattern in category_patterns.items():
                    matches = self._find_matches(compiled_pattern, section_content, pattern_name)
    ...
    def _find_matches(self, compiled_pattern: re.Pattern, content: str, pattern_name: str) -> List[PatternMatch]:
    ...
    def _find_section_for_position(self, position: int, content: str, sections: Dict[str, str]) -> Optional[str]:
        """
    ...
    def get_match_statistics(self, matches: Dict[str, List[PatternMatch]]) -> Dict[str, Any]:
        """
    ...
    def export_matches(self, matches: Dict[str, List[PatternMatch]], format: str = 'json') -> str:
        """
        ...
        if format == 'json':
            ...
            writer.writerow(['Category', 'Pattern', 'Text', 'Start', 'End', 'Section', 'Context'])
